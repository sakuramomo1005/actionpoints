...
# covariates set3
# covar_names = c('hamd17_baseline', 'age_evaluation',"dur_MDE", "age_MDE",  'axis2', "w0_1844","w0_1916", "w0_1915", "w0_1920")

# covariates, set 4
covar_names = c('hamd17_baseline', 'age_evaluation', "age_MDE",  'axis2',
...
# covariates, set 5 
covar_names = c("age_evaluation", "hamd17_baseline", "age_MDE", "Greg_FH",
  "hypersomnia", "axis2", "anger_attack", "anxious", 
  "w0_1915", "w0_1920")
...
for(iters in 1:100){
  ...
  source('cv_kl_sharecode_0414.R')
  
  result_kl = list(kllist = kllist,
                   Restable = Restable, 
  ...
  save(Result, file = 'embarc_cv_kl_linear_set4.RData')
