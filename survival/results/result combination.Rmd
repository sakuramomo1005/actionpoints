---
title: "Semi-parameter model estimation, with quantiles"
date: 2019-11-25
output: pdf_document
fontsize: 11pt
---
...
All the simulations below have generated data with size 500. And 500 times iterations. 
...
hist(data$death, freq = FALSE, breaks = 100, main = 'death time')
xxx = seq(0, 25,0.1)
lines(xxx, theta * exp(-theta * xxx), col =2, lwd = 3)
# g
hist(data$censor, freq = FALSE, breaks = 100, main = 'censor time')
lines(xxx, theta * exp(-exp(theta * xxx) + xxx * theta + 1), col =2, lwd = 3)
# x
hist(data$time, freq = FALSE, breaks = 100, main = 'observed time')
